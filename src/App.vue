    ...
    <div class="watches-wrapp">
      <div class="">
        <div class="wrapp">
          ...
          <StopwatchComponent v-for="stopWatcher in stopWatchers" :key="stopWatcher.id" class="stop-watch"
...
.plus {
  ...
  width: 20px;
  height: 20px;
  background: linear-gradient(to bottom, transparent 35%, #9E9E9E 35%, #9E9E9E 65%, transparent 65%), linear-gradient(to right, transparent 35%, #9E9E9E 35%, #9E9E9E 65%, transparent 65%);
}
</style>
